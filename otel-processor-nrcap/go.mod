...
require (
	...
	github.com/newrelic/nrdot-host/otel-processor-common v0.0.0-00010101000000-000000000000
...
replace github.com/newrelic/nrdot-host/otel-processor-common => ../otel-processor-common
